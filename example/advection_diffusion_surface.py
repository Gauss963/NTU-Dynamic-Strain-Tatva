# -*- coding: utf-8 -*-
"""advection_diffusion_surface.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/smec-ethz/tatva-docs/blob/main/docs/examples/advection_diffusion_surface.ipynb
...
# [collapse: code] Visualize the velocity field on the surface
...
"""![Imposed velocity profile](https://github.com/smec-ethz/tatva-docs/blob/main/docs/assets/plots/velocity_field.png?raw=1)
...
# [collapse: code] BiCGSTAB Linear Solver Implementation
...
c_curr = get_gaussian_initial_condition(mesh.coords, pole=jnp.array([1, 0., 0.]), sigma=0.15)
...
# [collapse: code] Visualize concentration on the surface at a specific time step
...
"""![Concentration profile at the end of the simulation](https://github.com/smec-ethz/tatva-docs/blob/main/docs/assets/plots/transport_concentration.png?raw=1)"""